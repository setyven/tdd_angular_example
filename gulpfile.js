...
gulp.task('serve', function (done) {
	if(options.env === 'prod') {
		...
		livereload.listen();
		runSequence('styles', 'coffee', 'connect', 'watch', done);
	}
});
...
gulp.task('build', ['jshint', 'ngSpecific', 'html', 'fonts', 'extras'], function () {
